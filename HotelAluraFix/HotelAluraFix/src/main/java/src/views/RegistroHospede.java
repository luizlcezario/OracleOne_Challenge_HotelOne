...
public class RegistroHospede extends JFrame {
	...
	public RegistroHospede() {
		...
		btnProximo.setBounds(723, 560, 122, 35);
		...
		btnProximo.setBackground(new Color(12, 138, 199));
		btnProximo.setVisible(false);
		contentPane.add(btnProximo);
		btnProximo.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));

		JLabel labelproximo = new JLabel("PROXIMO");
		labelproximo.setHorizontalAlignment(SwingConstants.CENTER);
		labelproximo.setForeground(Color.WHITE);
		labelproximo.setFont(new Font("Roboto", Font.PLAIN, 18));
		labelproximo.setBounds(0, 0, 122, 35);
		labelproximo.setVisible(false);
		btnProximo.add(labelproximo);
		...
		btnsalvar.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				String numero = rgController.saveNewClient(txtNome.getText(), txtSobrenome.getText(),new Date(txtDataN.getCalendar().getTimeInMillis()), txtNacionalidade.getSelectedItem().toString(), txtTelefone.getText());
				if (!Objects.equals(numero, "")) {
					txtNreserva.setText(numero);
					btnsalvar.setVisible(false);
					btnProximo.setVisible(true);
					labelSalvar.setVisible(false);
					labelproximo.setVisible(true);
				}
			}
		});
